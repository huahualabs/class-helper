export const SHARED_CLASS_ID = import.meta.env.VITE_CENTRAL_PORTAL_CLASS_ID || 'class-115-309'
...
export const CALENDAR_SOURCE_MODE = configuredSourceMode === CALENDAR_SOURCE_MODES.CENTRAL
